...
git clone https://github.com/AdarshVishwaraj/MaintainTrack-Pro.git
...
Pre-built installer available on the [Releases page](https://github.com/AdarshVishwaraj/MaintainTrack-Pro/releases).
...
|-------|------|-------|-------|
| **Phase 1** | 1–5 | AdarshVishwaraj | Project scaffold, DB schema, Equipment/Parts/Suppliers CRUD |
| **Phase 2** | 6–9 | AdarshVishwaraj | Maintenance scheduler, Breakdown log, Work order system (Days 8-9) |
...
| **Phase 4** | 20–28 | AdarshVishwaraj | Dashboard, KPIs, Activity Feed, PDF/Excel reports, deployment |

**Branch convention used:**
- `AdarshVishwaraj-phase3-complete-set-of-files-with-previous-phases-combined` — Adarsh
- `phase4/dashboard-kpis` — AdarshVishwaraj
