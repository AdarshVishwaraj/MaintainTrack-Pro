...
def seed(conn):
    ...
    conn.executemany("INSERT INTO MAINTENANCE_LOG (equipment_id,done_on,notes,done_by) VALUES (?,?,?,?);", [
        (1,str(TODAY-timedelta(days=150)),"Full lubrication and belt tension check","AdarshVishwaraj"),
        (1,str(TODAY-timedelta(days=120)),"Coolant flush, tool alignment verified","Ravi"),
        (1,str(TODAY-timedelta(days=90)), "Filter replaced, spindle check OK","AdarshVishwaraj"),
        (1,str(TODAY-timedelta(days=60)), "Belt replaced, lubrication done","Ankit"),
        (1,str(TODAY-timedelta(days=30)), "Full PM — all systems operational","AdarshVishwaraj"),
        ...
        (4,str(TODAY-timedelta(days=90)), "Air filter replaced, oil level OK","AdarshVishwaraj"),
        (4,str(TODAY-timedelta(days=45)), "Full PM — compressor serviced","Ankit"),
        (5,str(TODAY-timedelta(days=120)),"Tool alignment and lubrication","AdarshVishwaraj"),
        (5,str(TODAY-timedelta(days=90)), "Coolant flush, chuck cleaned","Priya"),
        (5,str(TODAY-timedelta(days=60)), "Motor brushes inspected — OK","AdarshVishwaraj"),
        ...
        (8,str(TODAY-timedelta(days=60)), "Full PM — motor inspection done","AdarshVishwaraj"),
    ])
    ...
    conn.executemany("INSERT INTO BREAKDOWN_LOG (equipment_id,occurred_on,description,resolved_by) VALUES (?,?,?,?);", [
        (1,str(TODAY-timedelta(days=135)),"Coolant pump failure — no coolant flow","AdarshVishwaraj"),
        ...
        (5,str(TODAY-timedelta(days=35)), "Motor overheating — coolant reservoir empty","AdarshVishwaraj"),
    ...
    conn.executemany("INSERT INTO ISSUE_RECORD (part_id,equipment_id,issued_on,qty,issued_by,type) VALUES (?,?,?,?,?,?);", [
        (7, 1,str(TODAY-timedelta(days=90)), 3,"AdarshVishwaraj","issue"),
        (12,1,str(TODAY-timedelta(days=60)), 2,"Ankit",  "issue"),
        (13,1,str(TODAY-timedelta(days=30)), 1,"AdarshVishwaraj","issue"),
        ...
        (6, 4,str(TODAY-timedelta(days=45)), 1,"AdarshVishwaraj","issue"),
        (4, 5,str(TODAY-timedelta(days=35)), 1,"AdarshVishwaraj","issue"),
        (7, 5,str(TODAY-timedelta(days=35)), 1,"AdarshVishwaraj","issue"),
        ...
        (3, 8,str(TODAY-timedelta(days=20)), 6,"AdarshVishwaraj","issue"),
    ])
